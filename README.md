...
- **"model"** and **"parameter"** columns define an initial value (in the form of "xi1", "xi2", ...) or parameter (in the form of "psi1", "psi2", etc.) of the corresponding model for which you are going to define values in the rest of the columns;
